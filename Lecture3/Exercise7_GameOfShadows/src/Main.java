...
//        printMatrix(matrix);
//
//        int countLinesX = countLines(matrix, 'X');
//        int countLinesO = countLines(matrix, 'O');
//
//        announceWinner(countLinesX, countLinesO);
    }
...
//
//        if(countX > countO) {
//            System.out.println("Player X wins with " + countX + " lines");
//        } else if (countO > countX) {
//            System.out.println("PLayer O wins with " + countO + " lines");
//        } else {
